...
<div class="header_new">
    <div class="header_box_new">
        ...
        <ul id="nav" class="nav_new">
            <li><a href="/index" class="nav-li_new {{if $tab_index=="index"}}now_new{{/if}}">首页</a></li>
            <li class="nav-child_new" id="t-pro">
                <a href="/prouducts/index" class="nav-li_new {{if $tab_index=="prouducts"}}now_new{{/if}}">产品<i></i></a>
                <!--产品与服务展开开始-->
            ...
            <li id="t-case">
                <a href="javascript:;" class="nav-li_new {{if $tab_index=="mod"}}now_new{{/if}}">案例<i></i></a>
                <div class="nav-hover_new">
                    <div class="nav-hover-bg_new"></div>
                    <div class="nav-hover-inner_new">
                        <ul class="nav-hover-inner-list_new">
            ...
            <li><a href="/internetadteam/landing" class="nav-li_new {{if $tab_index=="ad"}}now_new{{/if}}">广告</a></li>
            <li><a href="/channel/index" class="nav-li_new {{if $tab_index=="qudaozs"}}now_new{{/if}}">软件代理</a></li>
            <li id="t-wm"><a href="javascript:;" class="nav-li_new {{if $tab_index=="about"}}now_new{{/if}}">我们</a>
                <div class="nav-hover_new">
                    <div class="nav-hover-bg_new"></div>
                    <div class="nav-hover-inner_new">
                        <ul class="nav-hover-inner-list_new">
...
<!--头部结束-->
<!--
<div class="help_box" style="display:none; background-image: url({{$source_domain}}/whb/pc/site/images/r_float_bg.png);">
...
-->
<div class="t-zxzc">
    <div class="t-kf u-qq" id="docaht_wsl_open"><img src="{{$source_domain}}/whb/pc/site/images/index/t-e1.png"><p>在线支持</p></div>
